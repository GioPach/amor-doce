...
public class CatherineJones extends Personagem {
    
    /**
     * Constrói a personagem com suas conversas e atributos setados
     */
    public CatherineJones() {
        
    }
    
    public CatherineJones(String nome, String turma, int idade, String signo, String nacionalidade, char genero, String humor, NivelDificuldade nivel) {
