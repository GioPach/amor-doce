...
public class DylanAyala extends Personagem {
    ...
    public DylanAyala(String nome, String turma, int idade, String signo, String nacionalidade, char genero, String humor, NivelDificuldade nivel) {
