...
public class JudyWillis extends Personagem {
    ...
    public JudyWillis(String nome, String turma, int idade, String signo, String nacionalidade, char genero, String humor, NivelDificuldade nivel) {
