...
public class SusanneLefort extends Personagem {
    
    /**
     * Constrói a personagem com suas conversas e atributos setados
     */
    public SusanneLefort() {
        
    }
    
    public SusanneLefort(String nome, String turma, int idade, String signo, String nacionalidade, char genero, String humor, NivelDificuldade nivel) {
