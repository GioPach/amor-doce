...
public class MatthewWilliams extends Personagem {
    
    /**
     * Constrói a personagem com suas conversas e atributos setados
     */
    public MatthewWilliams() {
        
    }
    
    public MatthewWilliams(String nome, String turma, int idade, String signo, String nacionalidade, char genero, String humor, NivelDificuldade nivel) {
    ...
    private Conversa criarConversa2() {
        ...
        reacoesPossiveis.add(new Resposta(1, "Sou de ELE3, Ema, prazer."));
