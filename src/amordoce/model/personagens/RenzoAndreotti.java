...
public class RenzoAndreotti extends Personagem {
    
    /**
     * Constrói a personagem com suas conversas e atributos setados
     */
    public RenzoAndreotti() {
        
    }
    
    public RenzoAndreotti(String nome, String turma, int idade, String signo, String nacionalidade, char genero, String humor, NivelDificuldade nivel) {
