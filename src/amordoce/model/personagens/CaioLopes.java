...
public class CaioLopes extends Personagem {
    ...
    private Conversa criarConversa1() {
        ...
        respostasPossiveis.add(new Resposta(0, "Sim. Eu sou o aluno novo!", "Empolgado", 0.2));
        respostasPossiveis.add(new Resposta(1, "Sim...", "Neutro", 0.1));
        respostasPossiveis.add(new Resposta(2, "E se eu fosse?", "Irritado", -0.2, -0.1));
    ...
    private Conversa criarConversa3() {
        ...
        reacoesPossiveis.add(new Resposta(1, "Me chamo Caio..."));
